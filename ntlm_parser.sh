...
function display_help {
    ...
    echo
    echo "This script takes two input files and compares the values."
    echo "It displays the matches between the values of the first file"
    echo "and the second file. The script follows these steps:"
    echo
    ...
    echo
    echo "For each match found between NT_hash in both files,"
    echo "the script will display User:Password."
    echo "If no match is found, a message will be displayed."
    echo
    echo "Options:"
